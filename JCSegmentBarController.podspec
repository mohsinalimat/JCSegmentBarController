...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       An optional longer description of JCSegmentBarController

                       * Markdown format.
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/JCSegmentBarController"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "lijingcheng" => "bj_lijingcheng@163.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/JCSegmentBarController.git", :tag => s.version.to_s }
